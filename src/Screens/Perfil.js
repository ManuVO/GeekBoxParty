...
const Perfil = ({}) => {
  let avatar = Avatar
  let username = "Mircan"
  let bio = "Me gustan los juegos de mesa y soy muy bueno en el Sushi Go! gracias a los consejos de Juanjo el GeekExperto. Los gatos son mi pasión y me encanta hacer amigos. Juguemos juntos."
  let gamesJugados = 3
  let amigos = 3
  let monedas= 10450
  let EloConect = 1600
